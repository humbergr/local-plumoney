<script src="../send-cash.js"></script>
                                ...
                                <div class="row">
                                    <div class="col-5">
                                        <div class="d-flex flex-column justify-content-center align-items-center text-center text-primary mb-4 mb-md-0">
                                            <small class="mb-2">Quieres enviar</small>
                                            <img :src="getCountryImage(order.sender_fiat)" alt="Flag"
                                                 class="img-fluid"
                                                 style="max-height: 26px; max-width: 26px; object-fit: cover">
                                            <h3 class="mb-0">{{order.sender_fiat}}
                                                {{order.sender_fiat_amount.toLocaleString('en')}}</h3>
                                        </div>
                                    </div>
                                    <div class="col-2 text-center my-auto">
                                        <img src="/img/landing/sendPerson-secondary.svg"
                                             class="d-none d-md-inline-block"
                                             alt="Exchange">
                                    </div>
                                    <div class="col-5">
                                        <div class="d-flex flex-column justify-content-center align-items-center text-center text-primary mb-4 mb-md-0">
                                            <small class="mb-2">Entregamos</small>
                                            <img :src="getCountryImage(order.receiver_fiat)"
                                                 alt="Flag" class="img-fluid"
                                                 style="max-height: 26px; max-width: 26px; object-fit: cover">
                                            <h3 class="mb-0">{{order.receiver_fiat}}
                                                {{order.receiver_fiat_amount.toLocaleString('en')}}</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="__exchange_rate"
                                        ...
                                        Tasa de cambio:
                                        <strong>1 {{order.sender_fiat}}</strong> =
                                        <strong>{{recommendedUtility()}} {{order.receiver_fiat}}</strong>
                                    </div>
                                    <div class="__exchange_rate"
                                         v-else>
                                        Tasa de cambio:
                                        <strong>1 {{order.receiver_fiat}}</strong> =
                                        <strong>{{recommendedUtility()}} {{order.sender_fiat}}</strong>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="__account_data" v-for="(account_to_pay, index) in accounts_to_pay">
                                            ...
                                            <div class="body-bg-color rounded py-3 mb-4">
                                                <div class="row no-gutters">
                                                    ...
                                                    <countdown :account="account_to_pay"
                                                               :accounts="account_to_pay"
                                                               :order="order"
                                                               :operator="operatorID"
                                                               v-on:getMessages="getMessages"></countdown>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
