<template lang="html">
    <div class="__master_chat_dashboard">
        ...
        <aside class="asidebar border-left">
            <div class="d-flex flex-column h-100">
                ...
                <div class="h-100 border-top">
                    <div class="asidebar__header text-primary">Chat - Customers <br><small>Wallets</small></div>
        ...
        <section id="chat" class="chat--container">
            <wallets-order-transaction-chat
                    v-for="order in orders"
                    :key="order.id"
                    :order="order"
                    :user="user">
...
<script>
    ...
    export default {
        ...
        methods: {
            getOrders() {
                axios.get(window.location.origin + '/api/wallets/get-orders/')
                    .then(re => {
                        this.orders = re.data;
                    })
            },
