<script src="../WalletsOrderTransactionChatComponent.js"></script>
            ...
            <div class="chat__body loader--wrapper" :class="{ '--loading': loader }">
                ...
                <div id="chat-body" class="chat__msgs py-3 px-2" ref="scroller">
                    ...
                    <div v-for="msg in messages" class="chat__item mr-2">
                        <div v-if="(user.id === msg.sender_id || msg.user_account.role_id !== 5) && msg.msg !== '' "
                             class="media">
                            <div class="media-body">
                        ...
                        <div v-if="(user.id === msg.sender_id || msg.user_account.role_id !== 5) && msg.msg === '' && msg.attachment_name"
                             class="media">
                            <div class="media-body">
                ...
                <div id="send-bank-account"
                    ...
                    <form action="">
                        ...
                        <div class="form-group mb-2">
                            <cleave v-model="fiat_amount"
                                    :options="options"
                                    class="form-control form-control-font-sm"
                                    placeholder="Monto a depositar (requerido)"></cleave>
                ...
                <div class="chat__tools border-top">
                    ...
                    <textarea @keypress.enter="sendMessage" v-model="message" @focus="textFocus"
                              ...
                              style="max-height: none; height: 35px"></textarea>
