        ...
        <aside class="asidebar border-left">
            <div class="d-flex flex-column h-100">
                ...
                <div class="h-100 border-top">
                    <div class="asidebar__header text-primary">Active Chat - Customers <br>
                        <small>Exchange Transactions</small>
                    </div>
                    <ul id="wallets-contacts" class="list-unstyled contact__list" v-if="orders.length">
                        <li class="nav-item"
                            ...
                            <small style="display:block; font-size: 10px; padding-left: 1rem"
                                   data-toggle="tooltip"
