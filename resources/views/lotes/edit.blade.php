            ...
            <div class="col-md-4">
              <div class="form-group  ">
                ...
                <select id="usuario" name="user_id"
                  ...
                  <option value="{{$element->id}}" {{ old('user_id') == $element->id ? 'selected' : '' }}>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="form-group{{ $errors->has('monto') ? ' has-danger' : '' }}">
                ...
                <input type="number" step="any" name="monto" id="input-monto"
                  class="form-control  form-control-alternative{{ $errors->has('monto') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Monto:') }}" value="{{ old('monto', @$movimiento->monto) }}" required>
            ...
            <div class="col-md-3">
              <div class="form-group{{ $errors->has('tasa') ? ' has-danger' : '' }}">
                ...
                <input type="number" step="any" name="tasa" id="tasa"
                  ...
                  placeholder="{{ __('tasa:') }}" value="{{ old('tasa', @$movimiento->tasa) }}" required>
            ...
            <div class="col-md-3">
              <div class="form-group{{ $errors->has('monto_usd') ? ' has-danger' : '' }}">
                ...
                <input type="number" step="any" name="monto_usd" id="monto_usd"
                  class="form-control  form-control-alternative{{ $errors->has('monto_usd') ? ' is-invalid' : '' }}"
                  placeholder="{{ __('monto_usd:') }}" value="{{ old('monto_usd', @$movimiento->monto_usd) }}" required>
