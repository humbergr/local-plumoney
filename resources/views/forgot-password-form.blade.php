                          ...
                          <nav id="login-tabs" class="row no-gutters">
                              <div class="col-12">
                                  <a class="btn btn-secondary btn-block rounded-0 d-flex flex-column justify-content-center align-items-center h-100" href="#!">
                                      ...
                                      <small class="d-block">Establece tu nueva contraseña.</small>
                                  </a>
                              </div>
                          <!--    <div class="col-6">
                                  ...
                                  <div class="col-md-6 px-lg-5 mb-4 mb-md-0">
                                      <form method="POST" action="{{ URL::to('forgot-password-form') }}">
                                        ...
                                        <login-transaction></login-transaction>
                                          <h6 class="text-primary font-weight-bold mb-4">Nueva contraseña</h6>
                                          ...
                                          <div class="input-group mb-3">
                                              ...
                                              <input type="password" name="password-confirmation" class="form-control" placeholder="Confirma tu contraseña" required>
                                          </div>
