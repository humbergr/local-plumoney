...
<div class="email-content" style="padding: 2rem 3rem;">
    <h4 class="text-primary text-heading" style="margin: 0 0 1rem 0;color: #303392;font-weight: 400;font-size: 1.5rem;">New Transaction</h4>
    <p>{{$data['merchant']}} has created a new transaction.</p>
