...
<div class="email-content" style="padding: 2rem 3rem;">
    ...
    <p>Hola <strong>{{$data['receiver']}}</strong>, has recibido de manera exitosa <strong>{{number_format($data['amount'], 2)}} {{$data['currency']}}</strong> de parte de <strong>{{$data['sender']}}</strong>.</p>
