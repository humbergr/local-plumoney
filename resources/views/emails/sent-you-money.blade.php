...
@section('content')
    ...
    <div class="email-content" style="padding: 2rem 3rem;">
        <h4 class="text-primary text-heading" style="margin: 0 0 1rem 0;color: #303392;font-weight: 400;font-size: 1.5rem;">Te han enviado dinero.</h4>
        <p>Hola <strong>{{$data['receiver']}}</strong>, <strong>{{$data['sender']}}</strong> te ha enviado de manera exitosa <strong>{{number_format($data['amount'], 2)}} {{$data['currency']}}</strong> a través de nuestra plataforma.</p>
        <p>El dinero estará disponible en tu cuenta en las próximas horas.</p>
        <p>Si desconoces esta operación no dudes en contactar a nuestro servicio de soporte.</p>
