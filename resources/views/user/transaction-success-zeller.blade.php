                        ...
                        <div class="col-lg-4 col-xl-3 mb-3">
                            <div class="card card-body body-bg-color rounded-lg text-primary py-4 h-100 position-relative">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    ...
                                    <div class="font-14 font-weight-bold text-truncate">    {{$userExchangeTransaction->sender_fiat}}
                                        {{number_format($userExchangeTransaction->sender_fiat_amount, 2)}} {{$userExchangeTransaction->sender_fiat}}</div>
                                    </div>


                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <div class="small text-truncate mr-2">Tasa</div>
                                        <div class="font-14 font-weight-bold text-truncate">1 USD = {{$userExchangeTransaction->exchange_rate}}  </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <div class="font-14 font-weight-bold text-truncate">{{$userExchangeTransaction->sender_fiat}}
                                            {{number_format($userExchangeTransaction->receiver_fiat_amount, 2)}} {{$userExchangeTransaction->receiver_fiat}}</div> 
                                        </div>
                                        <div class="text-center mt-4">
                                            <div class="text-primary font-14">Total de transferencia</div>
                                            <h3 class="text-primary font-weight-bold mb-0">{{$userExchangeTransaction->sender_fiat}}
                                                {{number_format($userExchangeTransaction->sender_fiat_amount, 2)}} {{$userExchangeTransaction->sender_fiat}}</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-xl-3 mb-3">
                                        <div class="card card-body rounded-lg py-4 text-center shadow-none h-100 position-relative">
                                            ...
                                            <div class="copyToClipboard__container">
                                                ...
                                                <h3 class="d-inline mb-3"><input type="text" class="form-control custom-readonly text-center text-secondary font-weight-bold toCopy" readonly value="{{$userExchangeTransaction->tracking_id}}"></h3>
                                            </div>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a class="btn btn-light btn-sm" onclick="cargar()"  >Cargar imágen o PDF</a>
                                               ...
                                               <div class="form-group{{ $errors->has('numero_de_confirmacion') ? ' has-danger' : '' }}">
                                                                                <h6 class="card-title text-primary font-weight-bold  mt-5">{{ __('Número de confirmación') }}</h6>
