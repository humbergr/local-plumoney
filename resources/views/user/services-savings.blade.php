                    ...
                    <div class="row">
                        <div class="col-md-4 offset-md-1 my-auto">
                            <div class="text-center text-md-left wow fadeInUp">
                                <img src="/img/landing/pig-secondary.svg" alt="" class="img-fluid ml-md-5 mb-3">
                                <h1 class="text-primary font-weight-bold mb-4 mb-md-5">Guardar <span
                                            class="text-secondary">Dinero</span></h1>
                                <p>Proteje tu capital de las continuas depreciaciones de las monedas de tu país. Abre tu
                                    monedero digital y respalda tu dinero en Libras Esterlinas, Euros y Dólares.</p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 text-center text-md-right">
                            <img src="/img/landing/img944-hex.png" alt=""
                                 class="img-fluid wow fadeIn d-none d-md-block">
                        </div>
                        <div class="col-md-6 offset-md-1 my-auto">
                            <div class="text-center text-md-left wow fadeInUp">
                                <h5 class="text-primary font-weight-bold mb-3 mb-md-4">American Kryptos Bank resguarda y
                                    respalda tu dinero con máxima seguridad. Te permitimos tener el control real de tus
                                    finanzas, entregándote el poder de convertir y transferir tu dinero a la moneda que
                                    desees en cualquier parte del mundo.</h5>
                                <a href="javascript:void(0);"
                                   data-toggle="tooltip" title="Coming Soon"
                                   class="btn btn-secondary btn-lg btn-pill px-4 px-md-5 mt-4 mb-4 mb-md-0">
                                    <span class="mr-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25"
                                             viewBox="0 0 94 75"><g><g><g><g><path fill="#ffffff"
                                                                                   d="M51.17 13.237v.023c0 .749-.277 1.377-.785 1.825h-4.828a4.807 4.807 0 0 1-.836-.651l.725-.869c.78.758 1.783 1.15 2.675 1.15 1.026 0 1.783-.508 1.783-1.38 0-.033 0-.065-.004-.098z"/></g><g><g><g><g><g><path
                                    ...
                                    <span class="va-middle">Ahorra</span>
                                </a>
                            </div>
                        </div>
                    </div>
