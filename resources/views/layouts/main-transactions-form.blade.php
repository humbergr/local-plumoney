...
<body class="transaction-form internal">
...
<section class="head-1">
    <div class="grid-container">
        <div class="grid-x">
            <div class="cell"><a href="/"><img src="{{ asset('img/logo-internal.png') }}"
    ...
    <div class="wallet-zone">
        <div class="grid-container">
            <div class="grid-x">
                <div class="cell">
                    <div class="wallet">
                        <img src="{{ asset('img/icons/icon-bs-wallet.png') }}" alt="VES Wallet">
                        <p>
                            In your wallet
                    ...
                    <div class="wallet">
                        <img src="{{ asset('img/icons/icon-dollar-wallet.png') }}" alt="Dollar Wallet">
                        <p>
                            In your wallet
                    ...
                    <div class="wallet">
                        <img src="{{ asset('img/icons/icon-btc-wallet.png') }}" alt="BTC Wallet">
                        <p>
                            In your wallet
